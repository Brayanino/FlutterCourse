...
import 'package:flutter_application_responsive/swiper/controller/controller_events.dart';
import 'package:flutter_application_responsive/swiper/controller/swiper_controller.dart';
import 'package:flutter_application_responsive/swiper/properties/properties.dart';
import 'package:flutter_application_responsive/swiper/utils/cache_state.dart';
import 'package:flutter_application_responsive/swiper/utils/enums.dart';
import 'package:flutter_application_responsive/swiper/utils/number_extension.dart';
import 'package:flutter_application_responsive/swiper/utils/typedefs.dart';
import 'package:flutter_application_responsive/swiper/widgets/card_animation.dart';
...
class CardSwiper extends StatefulWidget {
  ...
  /// * As a rough rule of thumb, 0.1 change in [] effects a 35px change in [].
  final double scale;
  ...
  ///
  /// In order to keep the back card position same after changing the [],
  /// the [] should also be adjusted.
  /// * As a rough rule of thumb, 35px change in [] effects a
  /// [] change of 0.1.
  ///
  ...
  // final dynamic onEnd;
  // final dynamic allowedSwipeDirection;
